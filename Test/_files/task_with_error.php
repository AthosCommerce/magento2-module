...
/** @var TaskErrorInterfaceFactory $taskErrorFactory */
$taskErrorFactory = $objectManager->get(TaskErrorInterfaceFactory::class);

$error = $taskErrorFactory->create();
$error->setCode(1000);
$error->setMessage('Integration test task error message');
