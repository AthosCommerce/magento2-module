...
use AthosCommerce\Feed\Test\Integration\BackwardCompatibility\Configurable\Inventory\ChangeParentStockStatus;
...
foreach ($firstAttributeOptions as $option) {
    ...
    $product->setTypeId(Type::TYPE_SIMPLE)
        ...
        ->setDescription('DESC: AthosCommerce Test Configurable Option')
        ->setShortDescription('SHORT_DESC: AthosCommerce Test Configurable Option')
        ->setMetaTitle('Option: meta title')
        ->setMetaKeyword('Option: meta keyword')
        ->setMetaDescription('Option: meta description')
...
$product->setTypeId(Configurable::TYPE_CODE)
    ...
    ->setDescription('DESC: AthosCommerce Configurable Product Test CATALOG')
    ->setShortDescription('SHORT_DESC: AthosCommerce Configurable Product Test CATALOG')
    ->setMetaTitle('parent meta title')
    ->setMetaKeyword('parent meta keyword')
    ->setMetaDescription('parent meta description')
