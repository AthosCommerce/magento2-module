...
foreach ($firstAttributeOptions as $option) {
    ...
    $product->setTypeId(Type::TYPE_SIMPLE)
        ...
        ->setName('AthosCommerce Test Configurable Option OOS Simple' . $option->getLabel())
        ->setSku('athoscommerce_configurable_test_oos_simple_' . $productId)
        ->setPrice($productId)
...
$product->setTypeId(Configurable::TYPE_CODE)
    ->setAttributeSetId($attributeSetId)
    ->setWebsiteIds([$baseWebsite->getId()])
    ->setName('AthosCommerce Configurable Product Test OOS Simples')
    ->setSku('athoscommerce_configurable_test_oos_simple_configurable')
