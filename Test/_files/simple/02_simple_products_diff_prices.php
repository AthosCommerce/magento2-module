...
$product->setTypeId('simple')
    ->setAttributeSetId(4)
    ->setName('Athos Simple 1 With Different Price')
    ->setSku('athoscommerce_simple_diff_price_1')
    ->setPrice(12.99)
    ->setTaxClassId(0)
...
$product->setTypeId('simple')
    ->setAttributeSetId(4)
    ->setName('Athos Simple 2 With Different Price')
    ->setSku('athoscommerce_simple_diff_price_2')
    ->setPrice(9.99)
    ->setTaxClassId(0)
    ->setMetaTitle('meta title')
    ->setMetaKeyword('meta keyword')
