...
foreach ($firstAttributeOptions as $option) {
    ...
    $product->setTypeId(Type::TYPE_SIMPLE)
        ...
        ->setName('AthosCommerce Test Configurable Option Disabled Simple' . $option->getLabel())
        ->setSku('athoscommerce_configurable_test_disabled_simple_' . $productId)
        ->setPrice($productId)
...
$product->setTypeId(Configurable::TYPE_CODE)
    ->setAttributeSetId($attributeSetId)
    ->setWebsiteIds([$baseWebsite->getId()])
    ->setName('AthosCommerce Configurable Product Test Disabled Simple')
    ->setSku('athoscommerce_configurable_test_disabled_simple_configurable')
